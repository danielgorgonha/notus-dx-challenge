...
export function TokenInfoModal({ isOpen, onClose, tokenSymbol }: TokenInfoModalProps) {
  ...
  return (
    <>
      ...
      {/* Modal */}
      <div className="fixed bottom-0 left-0 right-0 z-[101] bg-slate-800 rounded-t-3xl border-t border-slate-700/50 max-h-[80vh] overflow-y-auto pb-safe-area-inset-bottom">
        {/* Handle */}
